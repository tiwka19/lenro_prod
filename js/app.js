(() => {
    ...
    (() => {
        ...
        window.addEventListener("click", (e => {
            ...
            if (!target.closest(".menu__body") && !target.closest(".icon-menu")) functions_menuClose();
        }));
        const script_showMore = () => {
            ...
            showMoreButton.addEventListener("click", (function() {
                ...
                if (this.classList.contains("active")) this.textContent = "Скрыть"; else this.textContent = "Показать еще";
            }));
        };
        script_showMore();
        const maps = () => {
            ...
            function init() {
                ...
                let moscowPlacemark = new ymaps.Placemark([ 55.707791, 37.595806 ], {
                ...
                let ptPlacemark = new ymaps.Placemark([ 60.043934, 30.489818 ], {
        ...
        menuLinks.forEach((link => {
            ...
            if (location == currentLink) link.classList.add("_active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
